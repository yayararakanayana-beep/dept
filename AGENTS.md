...
- Task22 must report `passed: false` when the existing runner cannot execute; synthetic metrics or fixed-zero boundary flags must not produce a passing validation.
