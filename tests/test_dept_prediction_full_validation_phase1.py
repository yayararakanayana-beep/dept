...
def test_full_validation_phase1_outputs_core_tables():
    ...
    assert set(outputs) == {
        ...
        "prediction_full_validation_phase1_usable_horizon",
...
def test_full_validation_phase1_boundary_passes_and_no_forbidden_v2_inputs():
    outputs = run_prediction_full_validation_phase1(_small_cfg())
...
def test_full_validation_phase1_summaries_report_observation_metrics_not_gates():
    outputs = run_prediction_full_validation_phase1(_small_cfg())
    ...
    assert usable["usable_horizon"].ge(0).all()
