...
def validate_output_dir(output_dir: Path) -> dict[str, Any]:
    ...
    for window in windows:
        ...
        required_keys = DERIVED_CONTEXT_WINDOW_KEYS if window.get("window_name") in {"v2_direct_benefit_window", "v2_direct_growth_window", "v2_h11_action_effect_window", "pressure_action_translation_audit_window"} else REQUIRED_WINDOW_KEYS
